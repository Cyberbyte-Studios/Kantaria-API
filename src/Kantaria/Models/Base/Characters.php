...
abstract class Characters implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Kantaria\\Models\\Map\\CharactersTableMap';
    ...
    /**
     * Initializes internal state of Kantaria\Models\Base\Characters object.
     */
     ...
     * @return $this|\Kantaria\Models\Characters The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CharactersTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[CharactersTableMap::COL_USER_ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[CharactersTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[CharactersTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setOxygen($v)
    {
        ...
        if ($this->oxygen !== $v) {
            $this->oxygen = $v;
            $this->modifiedColumns[CharactersTableMap::COL_OXYGEN] = true;
        }
    ...
    public function setFood($v)
    {
        ...
        if ($this->food !== $v) {
            $this->food = $v;
            $this->modifiedColumns[CharactersTableMap::COL_FOOD] = true;
        }
    ...
    public function setPosx($v)
    {
        ...
        if ($this->posx !== $v) {
            $this->posx = $v;
            $this->modifiedColumns[CharactersTableMap::COL_POSX] = true;
        }
    ...
    public function setPosy($v)
    {
        ...
        if ($this->posy !== $v) {
            $this->posy = $v;
            $this->modifiedColumns[CharactersTableMap::COL_POSY] = true;
        }
    ...
    public function setPosz($v)
    {
        ...
        if ($this->posz !== $v) {
            $this->posz = $v;
            $this->modifiedColumns[CharactersTableMap::COL_POSZ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CharactersTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CharactersTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CharactersTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CharactersTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CharactersTableMap::translateFieldName('Health', TableMap::TYPE_PHPNAME, $indexType)];
            $this->health = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CharactersTableMap::translateFieldName('Oxygen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oxygen = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CharactersTableMap::translateFieldName('Food', TableMap::TYPE_PHPNAME, $indexType)];
            $this->food = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CharactersTableMap::translateFieldName('Posx', TableMap::TYPE_PHPNAME, $indexType)];
            $this->posx = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CharactersTableMap::translateFieldName('Posy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->posy = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CharactersTableMap::translateFieldName('Posz', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = CharactersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Kantaria\\Models\\Characters'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CharactersTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CharactersTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CharactersTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'last_name';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_HEALTH)) {
            $modifiedColumns[':p' . $index++]  = 'health';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_OXYGEN)) {
            $modifiedColumns[':p' . $index++]  = 'oxygen';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_FOOD)) {
            $modifiedColumns[':p' . $index++]  = 'food';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSX)) {
            $modifiedColumns[':p' . $index++]  = 'posx';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSY)) {
            $modifiedColumns[':p' . $index++]  = 'posy';
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSZ)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Kantaria\Models\Characters
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Kantaria\Models\Characters The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CharactersTableMap::COL_ID)) {
            $criteria->add(CharactersTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_USER_ID)) {
            $criteria->add(CharactersTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_FIRST_NAME)) {
            $criteria->add(CharactersTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_LAST_NAME)) {
            $criteria->add(CharactersTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_HEALTH)) {
            $criteria->add(CharactersTableMap::COL_HEALTH, $this->health);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_OXYGEN)) {
            $criteria->add(CharactersTableMap::COL_OXYGEN, $this->oxygen);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_FOOD)) {
            $criteria->add(CharactersTableMap::COL_FOOD, $this->food);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSX)) {
            $criteria->add(CharactersTableMap::COL_POSX, $this->posx);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSY)) {
            $criteria->add(CharactersTableMap::COL_POSY, $this->posy);
        }
        if ($this->isColumnModified(CharactersTableMap::COL_POSZ)) {
            $criteria->add(CharactersTableMap::COL_POSZ, $this->posz);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Kantaria\Models\Characters (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Kantaria\Models\Characters Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addCharacterss($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeCharacters($this);
        }
        $this->id = null;
        $this->user_id = null;
