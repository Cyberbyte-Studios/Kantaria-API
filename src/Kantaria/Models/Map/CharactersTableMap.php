...
use Kantaria\Models\Characters;
use Kantaria\Models\CharactersQuery;
...
class CharactersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Kantaria.Models.Map.CharactersTableMap';
     ...
     */
    const OM_CLASS = '\\Kantaria\\Models\\Characters';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Kantaria.Models.Characters';
     ...
     */
    const COL_FIRST_NAME = 'characters.first_name';

    /**
     * the column name for the last_name field
     */
    const COL_LAST_NAME = 'characters.last_name';
     ...
     */
    const COL_OXYGEN = 'characters.oxygen';

    /**
     * the column name for the food field
     */
    const COL_FOOD = 'characters.food';

    /**
     * the column name for the posx field
     */
    const COL_POSX = 'characters.posx';

    /**
     * the column name for the posy field
     */
    const COL_POSY = 'characters.posy';

    /**
     * the column name for the posz field
     */
    const COL_POSZ = 'characters.posz';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CharactersTableMap::COL_ID, CharactersTableMap::COL_USER_ID, CharactersTableMap::COL_FIRST_NAME, CharactersTableMap::COL_LAST_NAME, CharactersTableMap::COL_HEALTH, CharactersTableMap::COL_OXYGEN, CharactersTableMap::COL_FOOD, CharactersTableMap::COL_POSX, CharactersTableMap::COL_POSY, CharactersTableMap::COL_POSZ, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CharactersTableMap::COL_ID => 0, CharactersTableMap::COL_USER_ID => 1, CharactersTableMap::COL_FIRST_NAME => 2, CharactersTableMap::COL_LAST_NAME => 3, CharactersTableMap::COL_HEALTH => 4, CharactersTableMap::COL_OXYGEN => 5, CharactersTableMap::COL_FOOD => 6, CharactersTableMap::COL_POSX => 7, CharactersTableMap::COL_POSY => 8, CharactersTableMap::COL_POSZ => 9, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Kantaria\\Models\\Characters');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CharactersTableMap::COL_ID);
            $criteria->addSelectColumn(CharactersTableMap::COL_USER_ID);
            $criteria->addSelectColumn(CharactersTableMap::COL_FIRST_NAME);
            $criteria->addSelectColumn(CharactersTableMap::COL_LAST_NAME);
            $criteria->addSelectColumn(CharactersTableMap::COL_HEALTH);
            $criteria->addSelectColumn(CharactersTableMap::COL_OXYGEN);
            $criteria->addSelectColumn(CharactersTableMap::COL_FOOD);
            $criteria->addSelectColumn(CharactersTableMap::COL_POSX);
            $criteria->addSelectColumn(CharactersTableMap::COL_POSY);
            $criteria->addSelectColumn(CharactersTableMap::COL_POSZ);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Kantaria\Models\Characters) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(CharactersTableMap::DATABASE_NAME);
            $criteria->add(CharactersTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CharactersTableMap::COL_ID) && $criteria->keyContainsValue(CharactersTableMap::COL_ID) ) {
